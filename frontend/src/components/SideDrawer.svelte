...
<section 
    style="width: {width};"
    class={"fixed h-screen p-2 z-20 top-0 flex flex-col justify-center items-center bg-theme-w border border-l-gray-400 border-r-gray-400 transition-transform duration-500"
