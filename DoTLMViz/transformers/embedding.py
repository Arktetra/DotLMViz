...
class PosEmbedding(nn.Module):
    ...
    def forward(
        ...
        Args:
            tokens (Tensor): batch of tokens of shape: (batch, position)

        Returns:
            Tensor: position embedded tensors of shape: (batch, position, d_model)
        """
...
class Unembedding(nn.Module):
    ...
    def forward(
        self, 
        normalized_resid_final: Float[Tensor, "batch seq_len d_model"]
